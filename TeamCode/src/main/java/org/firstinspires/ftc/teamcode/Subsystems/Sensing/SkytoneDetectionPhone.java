 ...
 * In an autonomous, call detect() to scan stones.
 */
public class SkytoneDetectionPhone {

    private final HardwareMap hardwareMap;
    private final Telemetry telemetry;

    public SkytoneDetectionPhone(final HardwareMap _hardwareMap, final Telemetry _telemetry) {
