...
@TeleOp(name = "NewScanner")
public class OpenCVScanner extends LinearOpMode
{
    OpenCvCamera webcam;
    ...
    public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.addData("Skystone X", detector.foundRectangle().x);
            telemetry.addData("Skystone Y", detector.foundRectangle().y);
            telemetry.update();
